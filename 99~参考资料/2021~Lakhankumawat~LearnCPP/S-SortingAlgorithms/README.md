...
- [CycleSortAlgorithm](#cyclesortalgorithm)
  - [Algorithm](#algorithm-8)
  - [Pseudocode](#pseudocode)
- [CycleSortProperties](#cyclesortproperties)
  - [Properties](#properties-8)
- [CycleSortAdvantages](#cyclesortadvantages)
  - [Advantages](#advantages-8)
- [CycleSortDisadvantages](#cyclesortdisadvantages)
  - [Disadvantage](#disadvantage-5)
- [CycleSortpractice-problems](#cyclesortpractice-problems)
  - [Link to practice problems](#link-to-practice-problems)
...
- Time Complexity:
  ...
  - `Worst Case Complexity: O(n^2)` - When there are elements of close range in the array, they are likely to be placed in the same bucket. This may result in some buckets having more number of elements than others. - It makes the complexity depend on the sorting algorithm used to sort the elements of the bucket.
