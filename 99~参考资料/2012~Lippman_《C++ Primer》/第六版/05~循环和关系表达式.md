...
![image-20210727003613922](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727003613922.png)
...
**赋值运算符是从右向左结合的**，因此首先将 0 赋给 z，然 后将 z = 0 赋给 y，依此类推。
...
![image-20210727010134791](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727010134791.png)
...
![image-20210727010733540](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727010733540.png)

### 5.1.7 前缀格式和后缀格式

如果变量被用于某些目的（如用作函数参数或给变量赋 值），使用前缀格式和后缀格式的结果将不同。

然而，虽然选择使用前缀格式还是后缀格式对程序的行为没有影 响，但执行速度可能有细微的差别。对于内置类型和当代的编译器而 言，这看似不是什么问题。然而，C++允许您针对类定义这些运算符，在这种情况下，用户这样定义前缀函数：将值加 1，然后返回结果；但后缀版本首先复制一个副本，将其加 1，然后将复制的副本返回。因 此，对于类而言，前缀版本的效率比后缀版本高。
...
![image-20210727012040437](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727012040437.png)

![image-20210727012104165](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727012104165.png)

### 5.1.10 复合语句（语句块）

只有这个地方要注意：假设对循环体进行了缩进，但省略了花括号，编译器将忽略缩进，因此只有第一条语句位于循环中。

![image-20210727012230040](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727012230040.png)
...
![image-20210727012641834](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727012641834.png)
...
![image-20210727013030988](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727013030988.png)

### 5.1.12 关系表达式

![image-20210727013059937](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727013059937.png)
...
![image-20210727014019373](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727014019373.png)
...
![image-20210727121115868](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727121115868.png)

### 5.2.1 for 与 while

在 C++中，for 和 while 循环本质上是相同的。

![image-20210727121739245](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727121739245.png)
...
![image-20210727133448815](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727133448815.png)
...
![image-20210727135803904](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727135803904.png)
...
![image-20210727161504704](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727161504704.png)
...
![image-20210727162259773](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727162259773.png)
...
![image-20210727162823543](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727162823543.png)

![image-20210727163014040](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727163014040.png)
...
![image-20210727163117901](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727163117901.png)
...
![image-20210727163540362](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727163540362.png)

![image-20210727163623327](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727163623327.png)

![image-20210727163905902](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/image-20210727163905902.png)
