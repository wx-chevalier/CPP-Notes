...
See also: [`decltype (C++11)`](02~软件/00~编程语言/CPP-Notes/00~现代%20C++%20版本/99~参考资料/modern-cpp-features/README.md#decltype).
...
See the section on [smart pointers (C++11)](02~软件/00~编程语言/CPP-Notes/00~现代%20C++%20版本/99~参考资料/modern-cpp-features/README.md#smart-pointers) for more information on `std::unique_ptr` and `std::shared_ptr`.
