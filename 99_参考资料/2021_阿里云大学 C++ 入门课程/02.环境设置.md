...
![img](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/154425967c4e731874.png)

4、左侧列表选择 Templates -> Visual C++ -> Win32 Console Application，并设置项目名为 MyFirstProgram。

![img](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/154430e60ee9018384.png)

5、点击 OK。

6、在以下窗口中点击 Next

![img](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/15444190dd2e989801.png)

7、在弹出的窗口中选择 Empty project 选项后，点击 Finish 按钮：

8、右击文件夹 Source File 并点击 Add --> New Item... :

![img](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/15445135154c170829.png)

9、选择 C++ File 然后设置文件名为 main.cpp，然后点击 Add：

![img](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/154459b03a55098499.png)
...
![img](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/15450518149e040143.png)

11、点击菜单上的 Debug -> Start Without Debugging (或按下 ctrl + F5) :

![img](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/154511746480630632.png)

12、完成以上操作后，你可以看到以下输出：

![img](https://ngte-superbed.oss-cn-beijing.aliyuncs.com/item/154519fb938f394280.png)
