...
![image-20210721153711828](https://assets.ng-tech.icu/item/image-20210721153711828.png)
...
![image-20210721154858602](https://assets.ng-tech.icu/item/image-20210721154858602.png)
...
![image-20210721160721085](https://assets.ng-tech.icu/item/image-20210721160721085.png)
...
![image-20210721161457763](https://assets.ng-tech.icu/item/image-20210721161457763.png)
...
![image-20210721162122919](https://assets.ng-tech.icu/item/image-20210721162122919.png)

用引号括起来的字符串**隐式**地包括结尾的空字符，因此不用显式地包括它。

最需要注意的是，**使用C-风格字符串，在确定存储字符串所需的最短数组时，别忘了+1，要将结尾的空字符计算在内**。

![image-20210721162704816](https://assets.ng-tech.icu/item/image-20210721162704816.png)

![image-20210721162840015](https://assets.ng-tech.icu/item/image-20210721162840015.png)
...
![image-20210721163221414](https://assets.ng-tech.icu/item/image-20210721163221414.png)
...
![image-20210721164300455](https://assets.ng-tech.icu/item/image-20210721164300455.png)
...
![image-20210721171126781](https://assets.ng-tech.icu/item/image-20210721171126781.png)
...
![image-20210722004651618](https://assets.ng-tech.icu/item/image-20210722004651618.png)

![image-20210722004809212](https://assets.ng-tech.icu/item/image-20210722004809212.png)
...
![image-20210722005755295](https://assets.ng-tech.icu/item/image-20210722005755295.png)
...
![image-20210722012337405](https://assets.ng-tech.icu/item/image-20210722012337405.png)
...
![image-20210722141823630](https://assets.ng-tech.icu/item/image-20210722141823630.png)

### 4.3.2 string 赋值、拼接和附加

string 可以如简单变量那般操作。比如，虽然不能将一个数组赋给另一个数组，但却可以将一个 string 对象赋给另一个 string 对象。

![image-20210722142110617](https://assets.ng-tech.icu/item/image-20210722142110617.png)
...
![image-20210722143658095](https://assets.ng-tech.icu/item/image-20210722143658095.png)
...
![image-20210722144341278](https://assets.ng-tech.icu/item/image-20210722144341278.png)
...
![image-20210722162656588](https://assets.ng-tech.icu/item/image-20210722162656588.png)
...
![image-20210722163912443](https://assets.ng-tech.icu/item/image-20210722163912443.png)
...
![image-20210722165020076](https://assets.ng-tech.icu/item/image-20210722165020076.png)

结构体的初始化方式和数组一样，使用逗号分隔值列表，并将这些值用花括号括起。如:

![image-20210722165157045](https://assets.ng-tech.icu/item/image-20210722165157045.png)

花括号中每个值可以独占一行，也可以将他们都放在同一行中，注意变量之间有逗号隔开就行，其他的随意。

### 4.4.2 C++11 结构体初始化

![image-20210722165537179](https://assets.ng-tech.icu/item/image-20210722165537179.png)

### 4.4.3 结构体可以将string类作为成员吗?

可以，只要编译器支持 string 类型就没问题，唯一要注意的问题注意添加名字空间 std 。 如:

![image-20210722165802188](https://assets.ng-tech.icu/item/image-20210722165802188.png)
...
![image-20210722170446818](https://assets.ng-tech.icu/item/image-20210722170446818.png)
...
![image-20210722170912740](https://assets.ng-tech.icu/item/image-20210722170912740.png)
...
![image-20210722171406230](https://assets.ng-tech.icu/item/image-20210722171406230.png)
...
这也是一个很少用的类型，略。
![image-20210722171825483](https://assets.ng-tech.icu/item/image-20210722171825483.png)
...
![image-20210722232030057](https://assets.ng-tech.icu/item/image-20210722232030057.png)
...
![image-20210722233255845](https://assets.ng-tech.icu/item/image-20210722233255845.png)
...
![image-20210722233705755](https://assets.ng-tech.icu/item/image-20210722233705755.png)
...
![image-20210723144325225](https://assets.ng-tech.icu/item/image-20210723144325225.png)
...
![image-20210723105004298](https://assets.ng-tech.icu/item/image-20210723105004298.png)
...
![image-20210723111823885](https://assets.ng-tech.icu/item/image-20210723111823885.png)
...
![image-20210723112411334](https://assets.ng-tech.icu/item/image-20210723112411334.png)
...
![image-20210723113548998](https://assets.ng-tech.icu/item/image-20210723113548998.png)
...
![image-20210723115130804](https://assets.ng-tech.icu/item/image-20210723115130804.png)
...
![image-20210723122618520](https://assets.ng-tech.icu/item/image-20210723122618520.png)
...
![image-20210723134422484](https://assets.ng-tech.icu/item/image-20210723134422484.png)
...
![image-20210723134903499](https://assets.ng-tech.icu/item/image-20210723134903499.png)
...
![image-20210723150508488](https://assets.ng-tech.icu/item/image-20210723150508488.png)
...
![image-20210723153517389](https://assets.ng-tech.icu/item/image-20210723153517389.png)

![image-20210723160219245](https://assets.ng-tech.icu/item/image-20210723160219245.png)
